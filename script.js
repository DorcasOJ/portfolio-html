...
document.querySelector(".menu-icon").addEventListener("click", (event) => {
  if (
    getComputedStyle(document.querySelector(".menu-open")).display ==
      "inline" ||
    getComputedStyle(document.querySelector(".menu-open")).display == "block"
  ) {
    ...
    getComputedStyle(document.querySelector(".menu-close")).display ===
      "block" ||
    getComputedStyle(document.querySelector(".menu-close")).display === "inline"
  ) {
...
function createImgBox(blog, _type, blogs) {
  ...
  if (_type === "project") {
    ...
    gitA.href = blog["github_link"];
    gitA.innerHTML = "View Github";
    divImgLink.appendChild(gitA);
  }
...
// send email
document
  .querySelector(".contact-content form button")
  .addEventListener("click", () => {
    ...
    const senderMessage = contactForm.querySelector(
      'input[name="message"]'
    ).value;
